...
export default function VendorBookingsPage() {
  ...
  return (
    <div className="p-5 lg:p-8 max-w-4xl mx-auto">
        ...
        <button onClick={() => router.push('/vendor/bookings/new')}
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#2c4a1e] text-white
                     text-sm font-semibold hover:bg-[#3d6b28] transition-colors flex-shrink-0">
